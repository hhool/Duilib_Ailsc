...
{
	CControlUI *pHeaderItem = GetItemAt(m_nsrot_index);
	if (pHeaderItem && pHeaderItem->GetInterface(DUI_CTR_LISTHEADERITEM))
		return static_cast<CListHeaderItemUI*>(pHeaderItem);
	return NULL;
}
